                      ...
                      child: GetBuilder<CartController>(builder:(_){
                        return Stack(
                          children: [
                            ...
                            Get.find<CartController>().totalItems > 0 ? Positioned(
                              right: 4,
                              top: 3,
                              child: Center(
                                  child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(10), // Sử dụng BorderRadius để bo tròn container
                                        color: Colors.red, // Thêm màu nền cho kiểu dáng đẹp hơn
                                      ),
                                      child: Text(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        TextWidget(
                            text: "128 comments", color: Color(0xFFccc7c5))
                      ],
                    ),
                    SizedBox(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                child: BigText(
                  size: 20,
                  text: "\$"+(productItem.price/100).toStringAsFixed(0)+ " | Add to cart",
                  color: Colors.white,
                ),
                padding:  EdgeInsets.all(Dimensions.padding20),
                decoration: BoxDecoration(
