                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              BigText(text: "\$ "+(cartController.getCarts[index].price/100).toStringAsFixed(0), color: Colors.redAccent),
                                              SizedBox(width: Dimensions.padding10,),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: Dimensions.padding10),
                        GetBuilder<CartController>(builder: (_){
                          return BigText(text: "\$ "+ (Get.find<CartController>().totalAmount/100).toStringAsFixed(0), color: AppColors.mainBlackColor);
                        },),
