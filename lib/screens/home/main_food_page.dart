                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              TextWidget(text: "128 comments", color: Color(0xFFccc7c5))
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              IconAndTextWidget(text: "In stock",
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: TextWidget(text: "Shoes Collection", color: AppColors.textColor)
                    ),
                  ],
                )
            ),
                                    ...
                                    child:Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(height: Dimensions.padding10,),
                                          TextWidget(text: "With Shoes characteristics", color: AppColors.textColor),
                                          SizedBox(height: Dimensions.padding10,),
                                          Row(
                                            mainAxisAlignment:MainAxisAlignment.spaceBetween,
                                            children: [
                                              IconAndTextWidget(text: "In stock", color: AppColors.textColor, icon: Icons.circle, iconColor: AppColors.iconColor1,),

                                              IconAndTextWidget(text: "5km",color: AppColors.textColor, icon: Icons.location_on, iconColor: AppColors.mainColor,),

                                              IconAndTextWidget(text: "20min",color:AppColors.textColor, icon: Icons.access_time_rounded, iconColor: AppColors.iconColor2,)
                                            ],
                                          )
                                        ],
                                      ),
